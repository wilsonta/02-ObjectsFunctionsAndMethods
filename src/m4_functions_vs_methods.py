...
def try_methods():
    brownturtle=rg.SimpleTurtle('turtle')
    brownturtle.pen=rg.Pen('brown',5)
    brownturtle.forward(150)
    brownturtle.left(90)
    brownturtle.forward(50)
    brownturtle.backward(100)
    """
...
def try_methods_and_functions():
    ...
    blueturtle.pen=rg.Pen('blue',5)
    blueturtle.backward(150)
    blueturtle.speed=1
    draw_many_squares(blueturtle,2,100,30)
    blueturtle.speed=5
    blueturtle.pen=rg.Pen('red',5)
    draw_many_squares(blueturtle,10,50,15)
    blueturtle.speed=100
    blueturtle.pen=rg.Pen('red',35)
    draw_many_squares(blueturtle,8,300,60)
